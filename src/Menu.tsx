...
export default function Menu() {
  ...
  const [arcProjectsOpen, setArcProjectsOpen] = React.useState(false);
  const [addProjectsOpen, setAddProjectsOpen] = React.useState(false);
        ...
        <List>
          ...
          <ListItem disablePadding sx={{ display: 'block' }}>
            <ListItemButton
              ...
              onClick={() =>
                (() => {
                  if (!open && !arcProjectsOpen) {
                    setOpen(true);
                  }
                  if (arcProjectsOpen) {
                    setArcProjectsOpen(false);
                  } else {
                    setArcProjectsOpen(true);
                  }
                })()
              }
            >
              ...
              <ListItemText primary={'Architecture Projects'} sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          ...
          <ListItem disablePadding sx={{ display: 'block' }}>
            ...
            >
              ...
              <ListItemText primary={'Additonal Projects'} sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
